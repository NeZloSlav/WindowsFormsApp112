...
namespace WindowsFormsApp112 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class Таблица1DataTable : global::System.Data.TypedTableBase<Таблица1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public Таблица1Row AddТаблица1Row(string Логин, string Пароль) {
        ...
        public partial class Таблица1Row : global::System.Data.DataRow {
            ...
            public string Логин {
                get {
                    try {
                        return ((string)(this[this.tableТаблица1.ЛогинColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Логин\' в таблице \'Таблица1\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableТаблица1.ЛогинColumn] = value;
                }
            }
            ...
            public string Пароль {
                get {
                    try {
                        return ((string)(this[this.tableТаблица1.ПарольColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Пароль\' в таблице \'Таблица1\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableТаблица1.ПарольColumn] = value;
                }
            }
            ...
            public bool IsЛогинNull() {
                return this.IsNull(this.tableТаблица1.ЛогинColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetЛогинNull() {
                this[this.tableТаблица1.ЛогинColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsПарольNull() {
                return this.IsNull(this.tableТаблица1.ПарольColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetПарольNull() {
                this[this.tableТаблица1.ПарольColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApp112.Database2DataSetTableAdapters {
    ...
    public partial class Таблица1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Таблица1` WHERE ((`Код` = ?) AND ((? = 1 AND `Логин` IS NULL) OR (`Л" +
                "огин` = ?)) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Таблица1` (`Логин`, `Пароль`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Таблица1` SET `Логин` = ?, `Пароль` = ? WHERE ((`Код` = ?) AND ((? = 1 AN" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp112.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Логин, Пароль FROM Таблица1";
        ...
        public virtual int Fill(Database2DataSet.Таблица1DataTable dataTable) {
        ...
        public virtual Database2DataSet.Таблица1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet.Таблица1DataTable dataTable = new Database2DataSet.Таблица1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet.Таблица1DataTable dataTable) {
